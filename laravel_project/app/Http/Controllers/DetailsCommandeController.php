...
use App\Http\Requests\DetailsCommandeRequest;
...
class DetailsCommandeController extends Controller
{
     ...
     */
    public function store(DetailsCommandeRequest $request)
    {
        //
    }
     ...
     */
    public function update(DetailsCommandeRequest $request, DetailsCommande $detailsCommande)
    {
        //
    }
